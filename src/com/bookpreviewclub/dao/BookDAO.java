...
public class BookDAO implements IBookDAO
{
	...
	{
		JdbcTemplate jdbcTemplateBean = (JdbcTemplate)context.getBean("getJdbcTemplate");
		String SQL = "SELECT B.Title, I.FirstName, I.LastName, B.PublicationYear FROM dbo.Book as B, dbo.Individuals as I, dbo.individualauthorxwalk as X WHERE I.IndividualID = X.IndividualID and B.AuthorID = X.AuthorID and (B.GenreID like '2')";
		return jdbcTemplateBean.query( SQL, new GenreBooksRowMapper());
	}
